...
public class Candidate {
    ...
    public static String fullName(String firstName, String lastNamePrefix, String lastName) {
       ...
       if (firstName != null) stringBuilder.append(firstName).append(" ");
       if (lastNamePrefix != null) stringBuilder.append(lastNamePrefix).append(" ");

        return stringBuilder.append(fullName).toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        return (Objects.equals(this.getFullName(), other.getFullName()) && this.party == other.party); // replace by a proper outcome
    }
    ...
    public int hashCode() {
        ...
        return getFullName().hashCode() + party.hashCode(); // replace by a proper outcome
    }
