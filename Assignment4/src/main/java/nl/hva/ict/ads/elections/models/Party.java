...
public class Party {
    ...
    public Candidate addOrGetCandidate(Candidate newCandidate) {
        ...
        if (this.candidates.contains(newCandidate)) {
            return this.candidates.stream().filter(c -> c.equals(newCandidate)).findFirst().orElse(null);
        }
    ...
    public boolean equals(Object o) {
        ...
        return (this.id == other.id && this.name == other.name); // replace by a proper outcome
    }
    ...
    public int hashCode() {
        ...
        return name.hashCode() + id; // replace by a proper outcome
    }
